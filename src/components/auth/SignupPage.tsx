...
import { Mail, Lock, User, Eye, EyeOff, AlertTriangle, RefreshCw } from 'lucide-react';
import { useAuth } from '../../contexts/AuthContext';

export default function SignupPage() {
  const navigate = useNavigate();
  const { signUp, signInWithGoogle, loading: authLoading, connectionError, retryConnection } = useAuth();
    ...
    <div className="min-h-screen bg-gradient-to-br from-surface-950 via-surface-950 to-surface-900 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Join SkillTree</h1>
        ...
        <div className="glass-card p-6 sm:p-8 space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-surface-950 text-gray-500">Or sign up with</span>
            </div>
          </div>
